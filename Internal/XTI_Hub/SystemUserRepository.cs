...
namespace XTI_Hub
{
    public sealed class SystemUserRepository
    {
        ...
        public async Task<AppUser> SetupSystemUser(AppKey appKey, string machineName, IHashedPassword hashedPassword, DateTimeOffset now)
        {
        ...
        public Task<AppUser> SystemUser(AppKey appKey, string machineName)
            => factory.Users.User(AppUserName.SystemUser(appKey, machineName));
