...
var AppEventSeverity = /** @class */ (function (_super) {
    ...
    AppEventSeverity.values = new AppEventSeveritys(new AppEventSeverity(0, 'Not Set'), new AppEventSeverity(100, 'Critical Error'), new AppEventSeverity(80, 'Access Denied'), new AppEventSeverity(70, 'App Error'), new AppEventSeverity(60, 'Validation Failed'));
