...
var MostRecentErrorEventListCardView = /** @class */ (function (_super) {
    tslib_1.__extends(MostRecentErrorEventListCardView, _super);
    function MostRecentErrorEventListCardView() {
        var _this = _super.call(this) || this;
        _this.titleHeader = _this.addCardTitleHeader();
        _this.alert = _this.addCardAlert();
        _this.errorEvents = _this.addBlockListGroup(function () { return new EventListItemView_1.EventListItemView(); });
        return _this;
    }
