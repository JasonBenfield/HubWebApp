        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                if (options.Command == "reset")
                {
                    ...
                    var mainDbReset = scope.ServiceProvider.GetService<HubDbReset>();
                ...
                else if (options.Command == "backup")
                {
                    ...
                    var mainDbBackup = scope.ServiceProvider.GetService<HubDbBackup>();
                ...
                else if (options.Command == "restore")
                {
                    ...
                    var mainDbRestore = scope.ServiceProvider.GetService<HubDbRestore>();
                    await mainDbRestore.Run(hostEnvironment.EnvironmentName, options.BackupFilePath);
                }
                else if (options.Command == "update")
                {
                    var mainDbContext = scope.ServiceProvider.GetService<HubDbContext>();
