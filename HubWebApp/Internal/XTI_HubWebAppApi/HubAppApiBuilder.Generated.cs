...
using XTI_HubWebAppApi.Commands;
...
public sealed partial class HubAppApiBuilder
{
    ...
    public HubAppApiBuilder(IServiceProvider sp, IAppApiUser user)
    {
        ...
        Commands = new CommandsGroupBuilder(source.AddGroup("Commands"));
        ...
        Installation = new InstallationGroupBuilder(source.AddGroup("Installation"));
    ...
    public CommandsGroupBuilder Commands { get; }
    ...
    public InstallationGroupBuilder Installation { get; }
