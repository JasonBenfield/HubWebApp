...
namespace XTIHubDB.EF.SqlServer
{
    ...
    [Migration("20260520131610_AppCommands")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XTI_HubDB.Entities.AppCommandEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LocationID", "CommandName", "Status");

                    b.ToTable("AppCommands", (string)null);
                });

            modelBuilder.Entity("XTI_HubDB.Entities.AppCommandInstallationEntity", b =>
                {
                    ...
                    b.HasKey("CommandID", "InstallationID");

                    b.HasIndex("InstallationID");

                    b.ToTable("AppCommandInstallations", (string)null);
                });

            modelBuilder.Entity("XTI_HubDB.Entities.AppCommandStepEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CommandID", "TimeStarted");

                    b.ToTable("AppCommandSteps", (string)null);
                });
            ...
            modelBuilder.Entity("XTI_HubDB.Entities.AppEntity", b =>
                {
                    ...
                    b.Property<string>("SerializedDefaultOptions")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)")
            ...
            modelBuilder.Entity("XTI_HubDB.Entities.AppUserEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("TimeLoggedIn")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("XTI_HubDB.Entities.ExpandedUser", b =>
                {
                    b.Property<int>("UserID")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset>("TimeUserAdded")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset>("TimeUserDeactivated")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.ToView("ExpandedUsers", (string)null);
                });
            ...
            modelBuilder.Entity("XTI_HubDB.Entities.SourceRequestEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SourceRequests", (string)null);
                });
            ...
            modelBuilder.Entity("XTI_HubDB.Entities.StoredObjectEntity", b =>
                {
                    ...
                    b.Property<string>("ExpirationTimeSpan")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("XTI_HubDB.Entities.AppCommandInstallationEntity", b =>
                {
                    b.HasOne("XTI_HubDB.Entities.AppCommandEntity", null)
                        .WithMany()
