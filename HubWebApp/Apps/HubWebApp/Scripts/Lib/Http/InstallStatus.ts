...
export class InstallStatuss extends NumericValues<InstallStatus> {
	constructor(
		...
		public readonly InstallRequested: InstallStatus,
		...
		super([NotSet,InstallRequested,InstallPending,InstallStarted,Installed,DeletePending,DeleteStarted,Deleted]);
	}
}
...
export class InstallStatus extends NumericValue implements IInstallStatus {
	public static readonly values = new InstallStatuss(
		...
		new InstallStatus(5, 'Install Requested'),
