...
export class UserGroupsPanelView extends GridView {
    ...
    readonly userGroupListView: LinkListGroupView<TextLinkListGroupItemView>;
    ...
    constructor(container: BasicComponentView) {
        ...
        this.userGroupListView = LinkListGroupView.addTo(mainContent, TextLinkListGroupItemView);
