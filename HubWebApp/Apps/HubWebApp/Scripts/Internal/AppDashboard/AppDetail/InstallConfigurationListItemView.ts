...
export class InstallConfigurationListItemView extends GridListGroupItemView {
    ...
    constructor(container: BasicComponentView) {
        ...
        this.configurationNameTextView = cell1.addView(TextBlockView);
        const cell2 = this.addCell();
        this.templateNameTextView = cell2.addView(TextBlockView);
        const cell3 = this.addCell();
        this.machineNameTextView = cell3.addView(TextBlockView);
    }
}