...
public sealed partial class AppGroup : AppClientGroup
{
    ...
    public Task<AppInstallCommandDetailModel> AddInstallCommand(string modifier, AddInstallCommandRequest requestData, CancellationToken ct = default) => Actions.AddInstallCommand.Post(modifier, requestData, ct);
