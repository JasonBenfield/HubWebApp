...
public sealed partial class UserInquiryGroup : AppClientGroup
{
    ...
    {
        Actions = new UserInquiryGroupActions(GetUser: CreatePostAction<AppUserIDRequest, AppUserModel>("GetUser"), GetUserOrAnon: CreatePostAction<AppUserNameRequest, AppUserModel>("GetUserOrAnon"), GetUserAuthenticators: CreatePostAction<AppUserIDRequest, UserAuthenticatorModel[]>("GetUserAuthenticators"), GetUsers: CreatePostAction<EmptyRequest, AppUserModel[]>("GetUsers"));
    }
    ...
    public sealed record UserInquiryGroupActions(AppClientPostAction<AppUserIDRequest, AppUserModel> GetUser, AppClientPostAction<AppUserNameRequest, AppUserModel> GetUserOrAnon, AppClientPostAction<AppUserIDRequest, UserAuthenticatorModel[]> GetUserAuthenticators, AppClientPostAction<EmptyRequest, AppUserModel[]> GetUsers);
}