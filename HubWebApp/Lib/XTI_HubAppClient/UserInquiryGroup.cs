...
public sealed partial class UserInquiryGroup : AppClientGroup
{
    ...
    {
        Actions = new UserInquiryGroupActions(GetUser: CreatePostAction<int, AppUserModel>("GetUser"), GetUserOrAnon: CreatePostAction<string, AppUserModel>("GetUserOrAnon"), GetUserAuthenticators: CreatePostAction<int, UserAuthenticatorModel[]>("GetUserAuthenticators"));
    }
    ...
    public sealed record UserInquiryGroupActions(AppClientPostAction<int, AppUserModel> GetUser, AppClientPostAction<string, AppUserModel> GetUserOrAnon, AppClientPostAction<int, UserAuthenticatorModel[]> GetUserAuthenticators);
}