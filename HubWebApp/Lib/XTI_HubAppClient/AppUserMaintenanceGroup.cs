...
public sealed partial class AppUserMaintenanceGroup : AppClientGroup
{
    ...
    public Task<EmptyActionResult> EditUserGroup(string modifier, EditUserGroupRequest requestData, CancellationToken ct = default) => Actions.EditUserGroup.Post(modifier, requestData, ct);
    ...
    public sealed record AppUserMaintenanceGroupActions(AppClientPostAction<UserModifierKey, EmptyActionResult> AllowAccess, AppClientPostAction<UserRoleRequest, int> AssignRole, AppClientPostAction<UserModifierKey, EmptyActionResult> DenyAccess, AppClientPostAction<EditUserGroupRequest, EmptyActionResult> EditUserGroup, AppClientPostAction<UserRoleRequest, EmptyActionResult> UnassignRole);
}