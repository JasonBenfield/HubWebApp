...
public sealed partial class UsersGroup : AppClientGroup
{
    ...
    {
        Actions = new UsersGroupActions(Index: CreateGetAction<GetUserRequest>("Index"), GetUserGroup: CreatePostAction<EmptyRequest, AppUserGroupModel>("GetUserGroup"), GetUsers: CreatePostAction<EmptyRequest, AppUserModel[]>("GetUsers"), AddOrUpdateUser: CreatePostAction<AddOrUpdateUserRequest, int>("AddOrUpdateUser"), AddUser: CreatePostAction<AddUserForm, AppUserModel>("AddUser"));
    }
    ...
    public Task<int> AddOrUpdateUser(string modifier, AddOrUpdateUserRequest model, CancellationToken ct = default) => Actions.AddOrUpdateUser.Post(modifier, model, ct);
    ...
    public sealed record UsersGroupActions(AppClientGetAction<GetUserRequest> Index, AppClientPostAction<EmptyRequest, AppUserGroupModel> GetUserGroup, AppClientPostAction<EmptyRequest, AppUserModel[]> GetUsers, AppClientPostAction<AddOrUpdateUserRequest, int> AddOrUpdateUser, AppClientPostAction<AddUserForm, AppUserModel> AddUser);
}